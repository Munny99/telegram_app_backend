...
import com.munni.telegram_app_backend.security.*;
...
//	}
	...
	void revokeAllUserTokens(Long userId) {
		List<Token> validTokens = tokenRepo.findAllByUserIdAndRevokedAndExpired(userId, false, false);
...
//	}
	...
	public AuthenticationResDto authenticateTelegram(TelegramLoginRequestDto request) {

		User user = userRepo.findByTelegramId(request.telegramId())
